...
def classify_text_with_natural_language_api(text_content):
    ...
    try:
        # Initialize the Natural Language client with the correct project
        ...
        # Print available attributes in language module to debug
        print("Available attributes in language_v1 module:", dir(language_v1))
        print("Using project: aiagent-465805")
...
def main():
    ...
    print("-" * 60)
    print("NOTE: This script uses your existing Google Cloud credentials")
    print("      No additional setup required - using same auth as Vision/Translation APIs\n")
